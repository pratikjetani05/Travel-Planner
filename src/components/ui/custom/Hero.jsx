  ...
  return (
    <div className="relative">
      ...
      <div className="relative w-full overflow-hidden">
        ...
        {/* Content */}
        <div className="relative z-10 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto py-20 lg:py-32">
          <div className="flex flex-col items-center gap-9 text-white">
            {/* Main Heading */}
            <h1 className="font-extrabold text-3xl sm:text-4xl lg:text-[50px] text-center animate-fade-in">
            ...
            {/* Description */}
            <p className="text-lg sm:text-xl text-gray-200 text-center max-w-3xl animate-fade-in-up">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <DestinationCard
              image={dest1}
              title="Paris, France"
              description="Experience the city of love with AI-crafted romantic itineraries"
              price="From $1,299"
              rating={4.8}
            />
            <DestinationCard
              image={dest2}
              title="Tokyo, Japan"
              description="Discover the perfect blend of tradition and modern culture"
              price="From $1,499"
              rating={4.9}
            />
            <DestinationCard
              image={dest3}
              title="New York, USA"
              description="Navigate the Big Apple with insider recommendations"
              price="From $999"
              rating={4.7}
            />
          </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            ...
            <ExperienceCard
              ...
              description="Curated stays for every budget"
            />
            <ExperienceCard
            ...
            <ExperienceCard
              ...
              title="Activities"
              description="Must-see attractions and hidden gems"
            />
          </div>
        </div>
      </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <TestimonialCard
              ...
              name="Sarah Mitchell"
              location="London, UK"
              text="The AI-powered itinerary was spot on! Saved me hours of planning and discovered hidden gems I wouldn't have found otherwise."
            />
            <TestimonialCard
              image="https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?auto=format&fit=crop&q=80"
              name="David Chen"
              location="Singapore"
              text="Incredible experience from start to finish. The personalized recommendations made our family trip to Japan unforgettable."
            />
            <TestimonialCard
              image="https://images.unsplash.com/photo-1438761681033-6461ffad8d80?auto=format&fit=crop&q=80"
              name="Emma Rodriguez"
              location="Barcelona, Spain"
              text="As a solo traveler, this platform gave me the confidence to explore new destinations with perfectly planned itineraries."
            />
          </div>
        </div>
      </div>
...
function DestinationCard({ image, title, description, price, rating }) {
  return (
    <div className="rounded-xl overflow-hidden shadow-lg transform hover:scale-105 transition-all duration-300 bg-white">
      <div className="relative">
